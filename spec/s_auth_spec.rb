...
describe 'The Authentication App' do
 include Rack::Test::Methods
	context "Tests of the application" do
		after(:all) do
			User.delete_all
			Application.destroy_all
			Utilization.destroy_all
		end
		    ...
		    describe "User connected and want to add an application" do
				  context "Validation of the post request" do
				    ...
				    it "should respond with a secret" do
				      last_response.status.should == 302
				      last_response.headers["Location"].should include "http://example.org/users/TestAjout?secret=IamSAuth"
				    end
